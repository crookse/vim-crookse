...
" Note: This theme uses crookse.colorsets from:
...
if has("gui_running")
    execute "highlight Normal "
		\. s:ui_mode . "fg=" . crookse.colorsets.015[s:index] . " "
...
execute "highlight Comment "
	\. s:ui_mode . "fg=" . crookse.colorsets.000[s:index] . " " 
	\. s:ui_mode . "=none"
execute "highlight Constant "
	\. s:ui_mode . "fg=" . crookse.colorsets.010[s:index] . " "
	\. s:ui_mode . "=none"
execute "highlight Identifier "
	\. s:ui_mode . "fg=" . crookse.colorsets.013[s:index] . " "
	\. s:ui_mode . "=none"
...
execute "highlight Function "
	\. s:ui_mode . "fg=" . crookse.colorsets.012[s:index] . " "
	\. s:ui_mode . "=none"
...
execute "highlight String "
	\. s:ui_mode . "fg=" . crookse.colorsets.011[s:index] . " "
	\. s:ui_mode . "=none"

" Set VIM UI colors
execute "highlight ColorColumn "
	\. s:ui_mode . "fg=" . crookse.colorsets.255[s:index] . " "
	\. s:ui_mode . "bg=" . crookse.colorsets.236[s:index]
execute "highlight Cursor "
	\. s:ui_mode . "fg=" . crookse.colorsets.011[s:index] . " "
	\. s:ui_mode . "bg=" . crookse.colorsets.005[s:index] . " "
	\. s:ui_mode . "=none"
...
execute "highlight Folded "
	\. s:ui_mode . "fg=" . crookse.colorsets.015[s:index] . " "
	\. s:ui_mode . "bg=" . crookse.colorsets.004[s:index] . " "
	\. s:ui_mode . "=none"
...
execute "highlight SpecialKey "
	\. s:ui_mode . "fg=" . crookse.colorsets.236[s:index] . " "
	\. s:ui_mode . "=none"
execute "highlight StatusLine "
	\. s:ui_mode . "fg=" . crookse.colorsets.004[s:index] . " "
	\. s:ui_mode . "bg=" . crookse.colorsets.004[s:index] . " "
	\. s:ui_mode . "=none"
execute "highlight StatusLineNC "
	\. s:ui_mode . "fg=" . crookse.colorsets.008[s:index] . " "
	\. s:ui_mode . "bg=" . crookse.colorsets.011[s:index] . " "
	\. s:ui_mode . "=none"
execute "highlight TabLine "
	\. s:ui_mode . "fg=" . crookse.colorsets.255[s:index] . " "
	\. s:ui_mode . "bg=" . crookse.colorsets.236[s:index]
execute "highlight TabLineFill "
	\. s:ui_mode . "fg=" . crookse.colorsets.232[s:index] . " "
	\. s:ui_mode . "bg=" . crookse.colorsets.255[s:index]
execute "highlight TabLineSel "
	\. s:ui_mode . "fg=" . crookse.colorsets.232[s:index] . " "
	\. s:ui_mode . "bg=" . crookse.colorsets.148[s:index]
execute "highlight Title "
	\. s:ui_mode . "fg=" . crookse.colorsets.001[s:index]
