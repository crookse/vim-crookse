...
execute "highlight graphqlStructure "
	\. s:ui_mode . "fg=" . s:langDefaultKeyword
execute "highlight graphqlName "
	\. s:ui_mode . "fg=" . s:white
execute "highlight graphqlVariable "
	\. s:ui_mode . "fg=" . s:white
execute "highlight graphqlTaggedTemplate "
	\. s:ui_mode . "fg=" . s:langDefaultKeyword
execute "highlight graphqlType "
	\. s:ui_mode . "fg=" . s:langDefaultIntegerFg
...
call s:SetColorFg("hclAttributeName", s:langDefaultKeyword)
call s:SetColorFg("hclBlockType", s:langDefaultIntegerFg)
